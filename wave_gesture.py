...
import wave1
def wave_direction_chooser(time_of_action,z_axis_values,array_var):
...
def wave_direction_chooser2(time_of_action2,z_axis_values2,array_var2):
...
while True:
    ...
    if len(lmList)==33:
        ...
        array_var,time_of_action,z_axis_values=wave_direction_chooser(time_of_action,z_axis_values,array_var)
        array_var2,time_of_action2,z_axis_values2=wave_direction_chooser2(time_of_action2,z_axis_values2,array_var2)
